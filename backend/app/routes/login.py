from backend.app.schemas import LoginResponse  # ✅ Absolute import
...
from backend.app.models import User, Company  # ✅ Absolute imports
...
def login(
    ...
    try:
        ...
        password_matches = (password == user.password)  # Fallback comparison
